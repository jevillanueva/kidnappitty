...
public class generalManager : MonoBehaviour {
	...
	public int subfase;
	enum currentStatus {inMiniGame, inTransitionWin, inTransitionLose, inGameOver, inStartGame,inHub}
	public currentStatus actualCurrentStatus;
	...
	public void initGame(){
		...
		faseActual = 0;
		fase = new fase[4];
		fase [0] = new fase (1, 1, 1);
		fase [1] = new fase (1, 1, 1);
		fase [2] = new fase (1, 1, 1);
		fase [3] = new fase (1, 1, 1);
